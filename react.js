...
cpiconr.current.style.display="none"; 
    ...
    errmsgR.current.firstChild.style.background = "red"; errmsgR.current.firstChild.textContent
...
piconl.current.style.display="none";
    ...
    errmsgL.current.firstChild.style.background = "red"; errmsgL.current.firstChild.textContent
     ="Email cannot be empty. Please enter your email";
     userL.focus();
...
piconl.current.style.display="none";
        ...
        userDivL.current.style.border="2px solid red";
     errmsgL.current.firstChild.style.background = "red"; uiconl.current.style.display="block";
     errmsgL.current.style.display="flex";
